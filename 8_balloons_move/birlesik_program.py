...
class MoveObject:
    ...
    def move_to_position(self, x, y, z):
        ...
        object_state.model_name = "big_ball"
...
class MoveObject:
    def __init__(self):
        rospy.init_node('move_object_node_big_clone', anonymous=True)
        self.object_pub = rospy.Publisher('/gazebo/set_model_state', ModelState, queue_size=10)

    def move_to_position(self, x, y, z):
    
        object_state = ModelState()
        object_state.model_name = "big_ball_clone"
        object_state.pose.position.x = x
        object_state.pose.position.y = y
        object_state.pose.position.z = z
...
class MoveObject:
    def __init__(self):
        rospy.init_node('move_object_node_big_clone_clone', anonymous=True)
        self.object_pub = rospy.Publisher('/gazebo/set_model_state', ModelState, queue_size=10)

    def move_to_position(self, x, y, z):
    
        object_state = ModelState()
        object_state.model_name = "big_ball_clone_clone"
        object_state.pose.position.x = x
        object_state.pose.position.y = y
        object_state.pose.position.z = z
...
class MoveObject:
    def __init__(self):
        rospy.init_node('move_object_node_little', anonymous=True)
        self.object_pub = rospy.Publisher('/gazebo/set_model_state', ModelState, queue_size=10)

    def move_to_position(self, x, y, z):
    
        object_state = ModelState()
        object_state.model_name = "little_ball"
        object_state.pose.position.x = x
        object_state.pose.position.y = y
        object_state.pose.position.z = z
...
class MoveObject:
    def __init__(self):
        rospy.init_node('move_object_node_medium', anonymous=True)
        self.object_pub = rospy.Publisher('/gazebo/set_model_state', ModelState, queue_size=10)

    def move_to_position(self, x, y, z):
    
        object_state = ModelState()
        object_state.model_name = "medium_ball"
        object_state.pose.position.x = x
        object_state.pose.position.y = y
        object_state.pose.position.z = z
...
class MoveObject:
    def __init__(self):
        rospy.init_node('move_object_node_medium_clone', anonymous=True)
        self.object_pub = rospy.Publisher('/gazebo/set_model_state', ModelState, queue_size=10)

    def move_to_position(self, x, y, z):
    
        object_state = ModelState()
        object_state.model_name = "medium_ball_clone"
        object_state.pose.position.x = x
        object_state.pose.position.y = y
        object_state.pose.position.z = z
...
class MoveObject:
    def __init__(self):
        rospy.init_node('move_object_node_medium_clone_0', anonymous=True)
        self.object_pub = rospy.Publisher('/gazebo/set_model_state', ModelState, queue_size=10)

    def move_to_position(self, x, y, z):
    
        object_state = ModelState()
        object_state.model_name = "medim_ball_clone_0"
        object_state.pose.position.x = x
        object_state.pose.position.y = y
        object_state.pose.position.z = z
